export default function AboutMe() {
  return (
    <section id="about">
      ...
      <p>
        Some of my proudest achievements include developing a task and
        time-tracking solution using SharePoint and Power Automate,
        creating interactive Power BI dashboards using DAX, and
        contributing business logic to TrustCircle.com, a platform
        that is now live and hosted online.
      </p>
